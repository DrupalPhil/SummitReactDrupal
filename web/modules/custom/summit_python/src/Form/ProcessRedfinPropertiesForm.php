...
/**
 * Class ProcessRedfinPropertiesForm.
 */
class ProcessRedfinPropertiesForm extends FormBase {

  /**
   * @var string
   */
  protected $queueWorkerPlugin = 'redfin_properties_queue';
...
//        \Drupal::logger('ProcessRedfinPropertiesForm')->info('Success');
      } catch (SuspendQueueException $e) {
        // If the worker indicates there is a problem with the whole queue,
        // release the item and skip to the next queue.
        $queue->releaseItem($item);
        \Drupal::logger('ProcessRedfinPropertiesForm')->error('Released');
        break;
      } catch (\Exception $e) {
        // In case of any other kind of exception, log it and leave the item
        // in the queue to be processed again later.
        \Drupal::logger('ProcessRedfinPropertiesForm')->error($e);
      }
    }
